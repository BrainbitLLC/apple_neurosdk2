Pod::Spec.new do |spec|
  ...
  spec.osx.vendored_libraries = 'neurosdk2.xcframework/ios-arm64/libneurosdk2.dylib', 'neurosdk2.xcframework/ios-arm64_x86_64-simulator/libneurosdk2.dylib'
  spec.ios.vendored_libraries = 'neurosdk2.xcframework/macos-arm64_x86_64/libneurosdk2.dylib', 'neurosdk2.xcframework/ios-arm64_x86_64-maccatalyst/libneurosdk2.dylib'
end
